        ...
        >
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 space-y-1">
                    ...
                    <a href="<?= base_url('audit') ?>" class="flex items-center px-4 py-3 text-sm font-medium text-slate-600 rounded-xl hover:bg-slate-50 hover:text-indigo-600 transition-colors">
